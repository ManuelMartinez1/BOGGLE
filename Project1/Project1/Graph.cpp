...
std::string Graph::getWordByIndex(std::vector<int>& vec, std::string tablero) {
    std::string s;
    for (auto u : vec)
...
bool Graph::pathInTrie(std::vector<int>& vec, std::string tablero, Trie* root) {
...
bool Graph::pathIsWord(std::vector<int>& vec, std::string tablero, Trie* root) {
...
std::vector<std::string> Graph::getAllPossibleWords(std::string tablero, Trie* raiz){
